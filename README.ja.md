...
| 機能 | 公式版 | max版 |
|------|--------|-------|
| Part ID修正 (OpenCode v1.2.25+) | ❌ クラッシュする | ✅ 修正済み |
| 日本語キーワード | ❌ | ✅ 11パターン対応 |
| セッション終了時の自動保存 | ❌ | ✅ 全スコープに保存 |
| コンテキスト再注入 | 初回メッセージのみ | ✅ 定期 + キーワード |
| Entity Context (抽出ガイド) | ❌ | ✅ Personal + Repo |
| 重複排除 | ❌ | ✅ 検索結果 + プロフィール |
| 相対時間表示 | ❌ | ✅ 「3時間前」「2日前」等 |
| Repoコンテナタグ (チーム共有) | ❌ | ✅ 3層: user/project/repo |
| シグナル抽出 (スマートフィルタ) | ❌ | ✅ キーワードベース |
| リコールキーワード | ❌ | ✅ 「思い出して」で即座に再取得 |
